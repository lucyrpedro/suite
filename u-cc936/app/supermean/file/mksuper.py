...
class UMFile(object):
    ...
    def __init__(self, archive_set, jobid, startyear, nyears, period):
...
class PPMeanVar(object):
    ...
    _exec = '/home/h02/hadeh/ppmnvar_rhel7/run_ppmnvar'
...
class MakeSuper(object):
    ...
    def __init__(self, workdir, archive_set, jobid, nyears, startyear, seasons):
